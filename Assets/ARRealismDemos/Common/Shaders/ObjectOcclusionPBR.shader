//-----------------------------------------------------------------------
// <copyright file="ObjectOcclusionPBR.shader" company="Google LLC">
//
...
// </copyright>
//-----------------------------------------------------------------------
Shader "ARRealism/Object Occlusion PBR"
{
    Properties
    {
        ...
        // The bias added to the estimated depth.
        // Useful to avoid occlusion of objects anchored to planes.
    ...
    SubShader
    {
        ...
        void surf(Input IN, inout SurfaceOutputStandard o)
        {
            ...
            fixed occlusion = tex2D(_OcclusionTex, IN.uv_MainTex);

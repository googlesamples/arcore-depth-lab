...
{
    private static readonly Vector4 _turboRedVec4 = new Vector4(
        0.13572138f, 4.61539260f, -42.66032258f, 132.13108234f);

    private static readonly Vector4 _turboGreenVec4 = new Vector4(
        0.09140261f, 2.19418839f, 4.84296658f, -14.18503333f);

    private static readonly Vector4 _turboBlueVec4 = new Vector4(
        0.10667330f, 12.64194608f, -60.58204836f, 110.36276771f);

    private static readonly Vector2 _turboRedVec2 = new Vector2(-152.94239396f, 59.28637943f);

    private static readonly Vector2 _turboGreenVec2 = new Vector2(4.27729857f, 2.82956604f);

    private static readonly Vector2 _turboBlueVec2 = new Vector2(-89.90310912f, 27.34824973f);
    ...
    public static Color Turbo(float x)
    {
        return GetPolynomialColor(
            1 - x, _turboRedVec4, _turboGreenVec4, _turboBlueVec4,
            _turboRedVec2, _turboGreenVec2, _turboBlueVec2);
    }
}
